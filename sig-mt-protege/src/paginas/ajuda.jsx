          ...
          <ul className="nav flex-column">
            <li className="nav-item">
              <a className="nav-link text-light" href="#">
                <img src={IconePainelPrincipal} alt="Icone Painel Principal" className="icone-painel-principal" />PAINEL PRINCIPAL
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-light" href="#">
              <img src={IconePolicia} alt="Icone Policial" className="icone-policia" />POLICIAIS
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link text-light" href="#">
